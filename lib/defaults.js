...
exports.GETTEXT_FUNC_ARGS_MAP = exports.GETTEXT_COMPONENT_PROPS_MAP = exports.BABEL_PARSING_OPTS = void 0;
...
var BABEL_PARSING_OPTS = {
  sourceType: 'module',
  plugins: ['jsx', 'asyncFunctions', 'classConstructorCall', 'doExpressions', 'trailingFunctionCommas', 'objectRestSpread', 'decorators-legacy', 'classProperties', 'exportExtensions', 'exportDefaultFrom', 'exportNamespaceFrom', 'exponentiationOperator', 'asyncGenerators', 'functionBind', 'functionSent', 'dynamicImport', 'optionalChaining', 'nullishCoalescingOperator', ['pipelineOperator', {
    'proposal': 'minimal'
  }]]
};
